...
img1_cv = cv2.imread('/home/javen/javenlib/images/bark/img1.ppm')
img2_cv = cv2.imread('/home/javen/javenlib/images/bark/img6.ppm')
degree = -90
...
#							  [0,0,1]]).real
rotation_matrix = javenlib.get_matrix_from_file('/home/javen/javenlib/images/bark/H1to6p')
print rotation_matrix

sift = cv2.SIFT(1000)
img1_kp_pos = sift.detect(img1_cv)
img1_kp_pos,img1_kp_des = sift.compute(img1_cv,img1_kp_pos)
img1_kp_pos = javenlib.KeyPoint_convert_forOpencv2(img1_kp_pos)
img2_kp_pos = sift.detect(img2_cv)
img2_kp_pos,img2_kp_des = sift.compute(img2_cv,img2_kp_pos)
