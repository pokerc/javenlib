...
#测试use_TILDE函数
sift = cv2.SIFT(250)
img_path_list = ['/home/javen/javenlib/images/EF_Dataset/lab580/img2_.jpg',
                 '/home/javen/javenlib/images/EF_Dataset/lab580/img3_.jpg']
...
# #第一种,已知的
# tranform_matrix = javenlib_tf.get_matrix_from_file('/home/javen/javenlib/images/EF_Dataset/rushmore/H3to5p')
#第二种,使用计算得到的变换矩阵
degree = -0
