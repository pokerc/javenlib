...
img_path_list = ['/home/javen/javenlib/images/bikes/img1.ppm',
                 '/home/javen/javenlib/images/bikes/img5.ppm']
tranform_matrix = javenlib_tf.get_matrix_from_file('/home/javen/javenlib/images/bikes/H1to5p')
imga = plt.imread(img_path_list[0])
imgb = plt.imread(img_path_list[1])
kp_set_afternms_list = javenlib_tf.use_TILDE_scale10(img_path_list)
print 'a yes!'
