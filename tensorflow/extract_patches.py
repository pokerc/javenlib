...
image_classname = 'kitti_campus_gray'
image_type = 'png'
#提取图片集合中的positive patches和negative patches
img_path_list = ['/home/javen/javenlib/images/'+image_classname+'/0000000000.'+image_type,
		 '/home/javen/javenlib/images/'+image_classname+'/0000000001.'+image_type,
		 '/home/javen/javenlib/images/'+image_classname+'/0000000002.'+image_type,
...
kp_set_positive = javenlib_tf.get_kp_set_positive(kp_set_raw,dist_threshold=36)
print 'kp_set_positive:',kp_set_positive.shape
# kp_patch_set_positive = javenlib_tf.get_kp_patch_set_positive(img_path_list,kp_set_positive,scale=8)
...
#保存positive patch集合
# np.save('/home/javen/javenlib/tensorflow/TILDE_data/20180408/'+image_classname+'_positive_patches.npy',kp_patch_set_positive)
# np.save('/home/javen/javenlib/tensorflow/TILDE_data/'+image_classname+'_positive_patches_laplacian.npy',kp_patch_set_positive)

kp_set_negative = javenlib_tf.get_kp_set_negative(kp_set_raw,dist_threshold=100)
print 'kp_set_nagative:',kp_set_negative.shape
kp_patch_set_negative = javenlib_tf.get_kp_patch_set_negative(img_path_list,kp_set_negative,scale=8)
...
#保存negative patch集合
# np.save('/home/javen/javenlib/tensorflow/TILDE_data/20180408/'+image_classname+'_negative_patches.npy',kp_patch_set_negative)
